...
export interface ApiDoctorDoctor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    doctor_categories: Attribute.Relation<
      'api::doctor.doctor',
      'oneToMany',
      'api::doctor-category.doctor-category'
    >;
...
export interface ApiDoctorCategoryDoctorCategory extends Schema.CollectionType {
  collectionName: 'doctor_categories';
  info: {
    singularName: 'doctor-category';
    pluralName: 'doctor-categories';
    displayName: 'Doctor Category';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSlotSlot extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::slot.slot', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::slot.slot', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::doctor-category.doctor-category': ApiDoctorCategoryDoctorCategory;
